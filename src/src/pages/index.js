        ...
        <div className={styles.news_container}>
          ...
          <div className={styles.faqjointwitter}>
            ...
            <div className={styles.twitter}>
              <h3>Twitter</h3>
              <a class="twitter-timeline" data-lang="ja" data-width="100%" data-height="600" data-theme="light" href="https://twitter.com/noko_denno?ref_src=twsrc%5Etfw">Tweets by noko_denno</a><br /><br />読み込んでいます…<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
          </div>
        </div>
      </main>
